...
<head>
    ...
    <style>
        ...
        .container i {
            display: block;
            background-image: url(/static/images/ie_guide.png);
        }
...
<div class="container">
    ...
    <div class="guide-box">
        <p class="mb">抱歉，系统不支持IE8以下的浏览器啦，</p>
        <p class="mb">为了更好的使用系统，您可以选择：</p>
        <ul>
            <li class="mb">
                <i class="o-guide-list1"></i>
                <span>升级浏览器<small class="above-tips">(&nbsp;已经是IE8及以上浏览器？请打开浏览器兼容模式，把兼容网站清空)
                    </small></span>
            </li>
            <li class="mb">
                <div>
            ...
            <!--<li class="mb">
                ...
                <span>如果您还是习惯使用当前的浏览器，请安装Chrome框架</span>
            </li>-->
            <li class="mb">
                <i class="o-guide-list3"></i>
                <span><a href="<?= Yii::$app->getHomeUrl()?>" target="_self">返回首页</a></span>
            </li>
        </ul>
    </div>
</div>
