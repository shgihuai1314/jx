...
/**
 * 数据库表结构文档自动生成工具
 * Class TableToMdController
 * 将表结构生成markdown格式的文档，使用实例如下：
 * ./yii table-to-md/create [all|tablename] [filename]
 * # 例如生成所有表到test.md文件
 ...
 * @since 2018-01-18
 */
class TableToMdController extends Controller
{
    /**
     * 数据库表生成
     */
